...
function myFunction(value) {
    alert("The form was submitted: " + value);
}
...
function uploadFile(node) {
    ...
    //var testfile = new File("","images/1.jpg",{type: 'image/jpeg'});
    //console.log("TEST FILE IS: " + testfile);
    
    //var file = node.previousSibling.files[0];
    
    //console.log("FILE LOOKS LIKE THIS" + file);
    ...
    //console.log("FILE ROW LOOKS LIKE THIS" + row);
    
    //var testfile = new File("","images/1.jpg");
    //console.log("TEST FILE IS: " + testfile);
    
    var form = new FormData();
    //form.append("file", file);
    form.append("filepath","test.jpg");
    //console.log("FORM LOOKS LIKE THIS: " + form);
